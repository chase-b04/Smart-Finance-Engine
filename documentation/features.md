...
-Develop a web app that allows users to interact with AI powered financial assistant\
-Scour the web for recent news articles (Just posted-180 days) pertaining to the company\
-Utilize an LLM, running on the AI100, to generate concise summaries of these articles.\
